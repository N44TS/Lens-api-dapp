...
export default function Profile() {
  ...
  async function followUser() {
    ...
    //wrapped in a try..catch block in case the transaction fails.
    try {
      //functions defined in the LensHub smart contract at https://docs.lens.xyz/docs/functions.
      //basically mints a follower nft
